...
class PenjualanByPengirimanLokasi extends Model
{
    use HasFactory, SoftDeletes;

    protected $fillable = [];
    protected $table = 'penjualan_by_pengirimans_lokasi';

    public function __construct(array $attributes = [])
    {
        parent::__construct($attributes);

        $columns = Schema::getColumnListing('penjualan_by_pengirimans_lokasi');

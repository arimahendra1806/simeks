    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix mb-4">
            ...
            <div class="pull-right">
                <a href="{{ route('admin.bank.create') }}" class="btn btn-primary btn-sm float-right">
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>{{ $item->nama }}</td>
                            <td>
                                <a href="{{ route('admin.bank.show', $item->id) }}" class="btn btn-info btn-sm">
                                    <i class="fa fa-info mr-2"></i> Detail
                                </a>
                                <form action="{{ route('admin.bank.destroy', $item->id) }}" method="POST"
